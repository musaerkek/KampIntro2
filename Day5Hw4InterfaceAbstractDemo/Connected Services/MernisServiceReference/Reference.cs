...
namespace Day5Hw4InterfaceAbstractDemo.MernisServiceReference {
    ...
    public interface KPSPublicSoap {
        ...
        Day5Hw4InterfaceAbstractDemo.MernisServiceReference.TCKimlikNoDogrulaResponse TCKimlikNoDogrula(Day5Hw4InterfaceAbstractDemo.MernisServiceReference.TCKimlikNoDogrulaRequest request);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tckimlik.nvi.gov.tr/WS/TCKimlikNoDogrula", ReplyAction="*")]
        System.Threading.Tasks.Task<Day5Hw4InterfaceAbstractDemo.MernisServiceReference.TCKimlikNoDogrulaResponse> TCKimlikNoDogrulaAsync(Day5Hw4InterfaceAbstractDemo.MernisServiceReference.TCKimlikNoDogrulaRequest request);
    }
    ...
    public partial class TCKimlikNoDogrulaRequest {
        ...
        public Day5Hw4InterfaceAbstractDemo.MernisServiceReference.TCKimlikNoDogrulaRequestBody Body;
        
        public TCKimlikNoDogrulaRequest() {
        }
        
        public TCKimlikNoDogrulaRequest(Day5Hw4InterfaceAbstractDemo.MernisServiceReference.TCKimlikNoDogrulaRequestBody Body) {
            this.Body = Body;
        }
    }
    ...
    public partial class TCKimlikNoDogrulaResponse {
        ...
        public Day5Hw4InterfaceAbstractDemo.MernisServiceReference.TCKimlikNoDogrulaResponseBody Body;
        
        public TCKimlikNoDogrulaResponse() {
        }
        
        public TCKimlikNoDogrulaResponse(Day5Hw4InterfaceAbstractDemo.MernisServiceReference.TCKimlikNoDogrulaResponseBody Body) {
            this.Body = Body;
        }
    }
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface KPSPublicSoapChannel : Day5Hw4InterfaceAbstractDemo.MernisServiceReference.KPSPublicSoap, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class KPSPublicSoapClient : System.ServiceModel.ClientBase<Day5Hw4InterfaceAbstractDemo.MernisServiceReference.KPSPublicSoap>, Day5Hw4InterfaceAbstractDemo.MernisServiceReference.KPSPublicSoap {
